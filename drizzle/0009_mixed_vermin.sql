...
CREATE UNIQUE INDEX IF NOT EXISTS "localized_text_cache_unique" ON "localized_text_cache" USING btree ("entity_type","entity_id","field","target_locale","source_hash");--> statement-breakpoint
