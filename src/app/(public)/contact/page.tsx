        ...
        <div className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-6 sm:py-16">
          <div className="max-w-3xl space-y-5">
            <h1 className="text-4xl font-semibold tracking-tight sm:text-5xl">
              {locale === "es"
                ? "Hablemos de tu producto, lanzamiento o ficha."
        ...
        <div className="mx-auto grid w-full max-w-6xl gap-8 px-4 py-14 sm:px-6 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="space-y-4">
            <h2 className="text-3xl font-semibold tracking-tight">
              {locale === "es" ? "Habla con el equipo" : "Reach the team"}
            </h2>
            <p className="text-base leading-7 text-muted-foreground">
              {locale === "es"
                ? "Usa el formulario o los datos de contacto de abajo para envíos, actualizaciones de fichas, correcciones y consultas generales."
                : "Use the form or the contact details below for submissions, listing updates, corrections, and general questions."}
            </p>
